package com.kumaj.opengl_es_playground;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CATEGORY_SAMPLE = "com.kumaj.opengl_es_playground.sample";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divider.setDrawable(new ColorDrawable(0xFFDCDCDC));
